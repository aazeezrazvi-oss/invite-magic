          ...
          <>
            ...
            <div className="space-y-4 pt-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <svg className="w-5 h-5 text-white opacity-85 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12.24 10.285V14.4 h6.887c-.648 2.41-2.519 4.114-5.136 4.114A5.53 5.53 0 0 1 8.46 13a5.53 5.53 0 0 1 5.53-5.53c2.25 0 4.225 1.134 5.378 2.87L22.6 7.1A9.7 9.7 0 0 0 13.99 3c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75c5.385 0 9.75-4.365 9.75-9.75 0-.616-.062-1.218-.184-1.808l-11.066.093z" />
                  </svg>
                </button>
              </div>
